...
namespace LAFABRICA.UI.Test.Components.pages.EmployeePayments
{
    public class EmployeePaymentTest :IClassFixture<BaseTest>
    {
        ...
        public void EditPaymentTestPay()
        {
            ...
            var editElement = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("edit-50")));
            ...
            inputDescription.SendKeys("Pago editar 50 Selenium - Pagado");
        ...
        public void EditPaymentTestCancel()
        {
            ...
            var editElement = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("edit-51")));
            ((IJavaScriptExecutor)_driver).ExecuteScript("arguments[0].click();", editElement);
            ...
            var inputDescription = _driver.FindElement(By.Id("inputDescription"));
            inputDescription.Clear();
            inputDescription.SendKeys("Pago editar 51 Selenium - anulado");
            inputDescription.SendKeys(Keys.Tab);
        ...
        public void EditPaymentTestDeleteProduct()
        {
            ...
            var editElement = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("edit-52")));
            ((IJavaScriptExecutor)_driver).ExecuteScript("arguments[0].click();", editElement);
            ...
            var inputDescription = _driver.FindElement(By.Id("inputDescription"));
            inputDescription.Clear();
            inputDescription.SendKeys("Eliminado un producto del 52");
            inputDescription.SendKeys(Keys.Tab);
